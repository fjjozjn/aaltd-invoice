            ...
            if($rs){
                ...
                if($rs){
                    ...
                    foreach($rtn_user as $v){
                        ...
                        //邮件的信息
                        //$info = "你好,<br />附件為新的工廠訂單 ".$_GET['approve_po_no'].", 要求出货日期為".$rtn['expected_date'].", 你亦可以在Sparkling Bright Ltd.系統內查看及覆期.<br />(此郵件為系統訊息, 請勿回覆)<br />Best Regards,<br />Assential Accessories LTD";
                        $info = $v['AdminName']." 你好,<br />新的工廠訂單 ".$_GET['approve_po_no'].", 要求出货日期為".$rtn['expected_date'].", 你亦可以在Sparkling Bright Ltd.系統內查看及覆期.<br />(此郵件為系統訊息, 請勿回覆)<br />Best Regards,<br />Assential Accessories LTD";
                ...
                if($user_rtn){
                    ...
                    //邮件的信息
                    //$info = "你好,<br />附件為新的工廠訂單 ".$_GET['approve_po_no'].", 要求出货日期為".$rtn['expected_date'].", 你亦可以在Sparkling Bright Ltd.系統內查看及覆期.<br />(此郵件為系統訊息, 請勿回覆)<br />Best Regards,<br />Assential Accessories LTD";
                    $info = trim($rtn['attention'])." 你好,<br />新的工廠訂單 ".$_GET['approve_po_no'].", 要求出货日期為".$rtn['expected_date'].", 你亦可以在Sparkling Bright Ltd.系統內查看及覆期.<br />(此郵件為系統訊息, 請勿回覆)<br />Best Regards,<br />Assential Accessories LTD";
